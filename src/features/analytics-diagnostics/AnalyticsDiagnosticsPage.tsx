...
import { ChartShell } from "../../components/organisms/ChartShell";
import { ChartEmptyState as EmptyChartState } from "../../components/organisms/ChartEmptyState";
import {
  chartPalette,
  ThemedHeatmapChart,
...
import type { AnalyticsMetricKey } from "../portfolio";
import {
    ...
    <>
      <section className="grid gap-4 md:grid-cols-4">
        <MetricCard
          size="compact"
          label="Portfólios"
          value={data.dataQuality.sourceCounts.portfolios}
        />
        <MetricCard
          size="compact"
          label="Snapshots"
          value={data.dataQuality.sourceCounts.snapshots}
        />
        <MetricCard size="compact" label="Ativos" value={data.dataQuality.sourceCounts.assets} />
        <MetricCard
          size="compact"
          label="Qualidade"
          value={labelQualityStatus(data.dataQuality.status)}
        />
      </section>
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        ...
        <ChartShell headingLevel="h2" eyebrow="Distribuição" title="Métricas selecionadas">
          <MetricDistributionPanel distributions={data.charts.metricDistributions} />
        </ChartShell>

        <ChartShell headingLevel="h2" eyebrow="Volatilidade" title="Janela móvel">
          <RollingLineChart
        ...
        <ChartShell headingLevel="h2" eyebrow="Correlação" title="Relações móveis">
          <CorrelationLineChart points={data.charts.rollingCorrelation} />
        </ChartShell>

        <ChartShell headingLevel="h2" eyebrow="Setores" title="Mapa de exposição">
          <ExposureHeatmap cells={data.charts.sectorExposureHeatmap} />
        </ChartShell>

        <ChartShell headingLevel="h2" eyebrow="Ativos" title="Mapa de exposição">
          <ExposureHeatmap cells={data.charts.assetExposureHeatmap} />
        </ChartShell>

        <ChartShell headingLevel="h2" eyebrow="Índice de referência" title="Sensibilidade">
          <BenchmarkSensitivityChart points={data.charts.benchmarkSensitivity} />
        </ChartShell>

        <ChartShell headingLevel="h2" eyebrow="Contribuição" title="Risco por posição">
          <RiskContributionChart points={data.charts.riskContribution} />
        </ChartShell>
      </section>

      <section className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_420px]">
        <ChartShell headingLevel="h2" eyebrow="Concentração" title="Classificação de portfólios">
          <ConcentrationRankingTable rows={data.charts.concentrationRanking} />
        </ChartShell>
        <ChartShell headingLevel="h2" eyebrow="Dados" title="Linha do tempo e provedores">
