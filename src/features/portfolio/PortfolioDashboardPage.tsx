...
import { AppHeader, LogoutButton, ProtectedRoute, useAuth, type UserRole } from "../auth";
...
import { convertCurrency, createPortfolio, listPortfolios } from "./portfolioApi";
import { CurrencyConversion, PortfolioListItem } from "./types";
